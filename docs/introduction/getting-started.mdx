...
Install Python Liquid from [PyPi](https://pypi.org/project/python-liquid/):

<Tabs groupId="pypi-manager">
...
Or [conda-forge](https://anaconda.org/conda-forge/python-liquid):

<Tabs groupId="conda-manager">
...
<TabItem value="miniforge" label="miniforge">
...
<TabItem value="mamba" label="mamba">
