...
const FeatureList: FeatureItem[] = [
  {
    ...
    description: (
      <>
        Python Liquid strives to be 100% compatible with the reference implementation
        of Liquid, written in Ruby. See the <Link to="./known_issues"> known issues
        page</Link> for a description of differences between Python Liquid and Ruby Liquid.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    description: (
      <>
        Integrate with <Link to="https://www.djangoproject.com/">Django</Link> or <Link to="https://flask.palletsprojects.com/">
        Flask</Link> using the <Link to="/guides/django-liquid">Django template backend</Link> for Python Liquid or the  <Link
        to="/guides/flask-liquid">Flask extension</Link> for Python Liquid.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        Optionally load templates and render context data asynchronously with Python
        Liquid's <Link to="/introduction/async-support">async API</Link>, built with <Link
        to="https://docs.python.org/3/library/asyncio.html">asyncio</Link>.
      </>
    ),
  },
];
